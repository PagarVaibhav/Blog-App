...
import com.VaibhavIT.blog.Config.AppConstants;
...
public class PostController {
	...
	public ResponseEntity<PostDto> getPerticularPost(@PathVariable Integer postId){
	...
	public ApiResponce deletePost(@PathVariable Integer postId){
		...
		return new ApiResponce("Post Deleted Succussfully ", true);
	}
	...
	//Method For Download or Serve File
	
	@GetMapping(value="/posts/image/{imageName}",produces = MediaType.IMAGE_JPEG_VALUE)
	public void downloadImage(@PathVariable("imageName") String imageName, HttpServletResponse responce) throws IOException {
